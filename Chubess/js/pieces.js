...
function preload() {
    pawnModel = loadModel('/models/pawn.obj');
    knightModel = loadModel('/models/knight.obj');
    bishopModel = loadModel('/models/bishop.obj');
    rookModel = loadModel('/models/rook.obj');
    queenModel = loadModel('/models/queen.obj');
    kingModel = loadModel('/models/king.obj');
}
